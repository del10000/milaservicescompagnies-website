  ...
  return (
    <div className="relative py-16 bg-white">
      <div
        ...
        aria-hidden="true"
      />
      <div className="max-w-7xl mx-auto bg-gray-50 lg:bg-transparent lg:px-8 pb-36">
      ...
      <div className="max-w-7xl mx-auto bg-gray-50 lg:bg-transparent lg:px-8">
        <div className="lg:grid">
          <div className="relative z-10 lg:col-end-12 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
            <div
              className="absolute inset-x-0 h-1/2 lg:hidden"
              aria-hidden="true"
            />
            <div className="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-md lg:p-0">
              <div className="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1">
                <img
                  className="object-fill object-center rounded-3xl shadow-2xl"
          ...
          <div className="relative bg-gray-900 lg:col-end-9 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            {/* <div
              className="hidden absolute inset-0 overflow-hidden rounded-3xl lg:block"
              aria-hidden="true"
            >
